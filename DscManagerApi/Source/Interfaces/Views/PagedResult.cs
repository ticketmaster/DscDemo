// --------------------------------------------------------------------------------------------------------------------
// <copyright file="PagedResult.cs" company="Ticketmaster">
//   Copyright 2015 Ticketmaster
// </copyright>
// --------------------------------------------------------------------------------------------------------------------

namespace Ticketmaster.Dsc.Interfaces.Views
{
    using System;
    ...
    using HttpMethod = Ticketmaster.Dsc.Interfaces.DeploymentServer.ViewModels.HttpMethod;
    ...
    /// <typeparam name="T">
    /// </typeparam>
    public class PagedResult<T> : IViewModel
    {
        /// <summary>
