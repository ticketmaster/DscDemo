// --------------------------------------------------------------------------------------------------------------------
// <copyright file="ConfigurationView.cs" company="Ticketmaster">
...
namespace Ticketmaster.Dsc.Interfaces.DeploymentServer.ViewModels
{
    ...
    /// </summary>
    public class ConfigurationView : IViewModel
    {
        /// <summary>
        ...
        /// The url helper.
        /// </param>
        public ConfigurationView(UrlHelper urlHelper)
        {
            this.UrlHelper = urlHelper;
        }

        /// <summary>
        ///     Gets or sets the archive configurations.
        /// </summary>
        public IEnumerable<ArchiveConfigurationView> ArchiveConfigurations { get; set; }
